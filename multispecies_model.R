...
# Set the working directory on line 26
# Edit line 29 depending on operating system
# Run all code

### Editing the inputs
# Open data_template.xlsx and populate sheets with own data accordingly
# Edit baseline parameters in lines 32-41 to own specifications as per data template
# Edit model parameters in lines 464:577
# Edit plots in lines 1409:1486

#For further information, please contact Sheetal.Silal@uct.ac.za
